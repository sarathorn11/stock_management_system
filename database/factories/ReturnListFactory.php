...
class ReturnListFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'stock_ids' => json_encode([$this->faker->numberBetween(1, 100), $this->faker->numberBetween(1, 100)]), // JSON array of stock IDs            'amount' => $this->faker->randomFloat(2, 100, 10000), // Random amount between 100 and 10,000
