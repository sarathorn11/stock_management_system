...
<div id="content" class="w-full h-full">
  ...
  <div class="w-full h-auto bg-white p-8 mt-4 rounded-lg">
    <div class="flex items-center justify-between mb-4">
      <input type="text" placeholder="Search..." class="px-3 py-2 w-[350px] rounded border">
      ...
      <table class="table-auto w-full">
        ...
        <tbody>
          ...
          <tr class="bg-white hover:bg-gray-200">
            ...
            <td class="p-4 text-center">{{ \Carbon\Carbon::parse($stock->date_created)->format('Y-m-d h:i A') }}
            </td>
