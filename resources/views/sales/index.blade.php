    ...
    <table class="table-auto w-full border">
      ...
      <tbody id="salesResults">
        ...
        <tr class="bg-white hover:bg-gray-200 border-b">
          ...
          <td class="p-2 text-center">{{ $sale->created_at }}</td>
          <td class="p-2 text-center">{{ $sale->sales_code }}</td>
          <td class="p-2 text-center">{{ $sale->client }}</td>
          <td class="p-2 text-center">{{ count($sale->saleItems) }}</td>
        ...
        @empty
        <tr class="bg-white hover:bg-gray-200 border-b"></tr>
          <td colspan="7" class="text-center p-4">No results found.</td>
        </tr>
        @endforelse
      </tbody>
    </table>
