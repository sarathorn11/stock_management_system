...
<div class="w-full h-full">
  <h1 class="text-3xl font-bold text-gray-800">Edit Sale</h1>
  <div class="w-full h-auto bg-white p-8 my-4">
    <form action="{{ route('sales.update', $sale->id) }}" method="POST" class="m-0">
      ...
      <div class="flex items-center justify-end">
        ...
        <button type="submit"
          class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Update</button>
      </div>
    </form>
  </div>
</div>
